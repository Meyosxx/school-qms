    ...
    <div className="display-container" style={{ backgroundColor: settings.secondary_color }}>
      ...
      <div className="display-marquee">
        <div className="marquee-track">
          <span>
            Visit our official website at electroncollege.edu.ph and our Facebook page, Electron College of Technical Education.
          </span>
        </div>
      </div>
      ...
      <div className="display-footer" style={{ borderTop: `4px solid ${settings.primary_color}`, backgroundColor: 'rgba(0,0,0,0.35)' }}>
        <div className="footer-info">
          ...
          <div className="footer-text">
            <div>+63 917 137 9827</div>
            <div>664 Electron Bldg. Quirino Highway, Bagbag, Novaliches Quezon City</div>
            <div>Electron College of Technical Education</div>
          </div>
        </div>
      </div>
    </div>
